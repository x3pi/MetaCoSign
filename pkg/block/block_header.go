...
func NewBlockHeader(
	...
	return &BlockHeader{
		...
		stakeStatesRoot:   stakeStatesRoot, // Bổ sung StakeStatesRoot
...
func (b *BlockHeader) Proto() *pb.BlockHeader {
	return &pb.BlockHeader{
		...
		StakeStatesRoot:   b.stakeStatesRoot.Bytes(), // Bổ sung StakeStatesRoot
...
func (b *BlockHeader) FromProto(pbBlockHeader *pb.BlockHeader) {
	...
	b.stakeStatesRoot = common.BytesToHash(pbBlockHeader.StakeStatesRoot) // Bổ sung StakeStatesRoot
...
`, b.lastBlockHash, b.blockNumber, b.accountStatesRoot, b.stakeStatesRoot, b.receiptRoot, b.TransactionsRoot(), b.leaderAddress, b.timeStamp, b.aggregateSignature) // Bổ sung StakeStatesRoot
	return str
}
