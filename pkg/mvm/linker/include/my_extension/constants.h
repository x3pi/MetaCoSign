...
namespace mvm
{
    ...
    {
    public:
        static uint32_t getFunctionSelectorFromString(const std::string &functionSignature);
        static uint256_t getPaddedAddressSelector(const std::string &functionSignature);
