...
const file_event_log_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x14.event_log.EventLogsR\x05value:\x028\x01B1\n" +
...
var file_event_log_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_event_log_proto_goTypes = []any{
	...
	nil,                       // 4: event_log.MapEventLogs.EventsByAddressEntry
}
var file_event_log_proto_depIdxs = []int32{
	0, // 0: event_log.EventLogs.EventLogs:type_name -> event_log.EventLog
	4, // 1: event_log.MapEventLogs.events_by_address:type_name -> event_log.MapEventLogs.EventsByAddressEntry
	2, // 2: event_log.MapEventLogs.EventsByAddressEntry.value:type_name -> event_log.EventLogs
